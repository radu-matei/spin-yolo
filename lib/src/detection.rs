use crate::bindings::{self, exports::component::face_detection_lib::face_detection::Image};

use std::{cmp::Ordering, io::Cursor};

use anyhow::Error;
use bindings::exports::component::face_detection_lib::face_detection::DetectionResult;
use image::DynamicImage;

use tract_ndarray::s;
use tract_onnx::prelude::*;

pub fn detect(img: Image, confidence: f32) -> Result<Vec<DetectionResult>, Error> {

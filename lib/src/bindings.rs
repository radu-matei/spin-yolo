...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:component:face-detection-lib:classification:encoded world"]
#[doc(hidden)]
...
\x13confidence-tresholdv\0\x07\x04\0\x06detect\x01\x08\x04\0+component:face-dete\
ction-lib/face-detection\x05\0\x04\0+component:face-detection-lib/classification\
\x04\0\x0b\x14\x01\0\x0eclassification\x03\0\0\0G\x09producers\x01\x0cprocessed-\
